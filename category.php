...
<html lang="en">
  ...
  <head>
    ...
    <title>Portal IMENHA| Categorias</title>
...
<h1><?php echo htmlentities($row['category']);?> News</h1>
          ...
          <a href="news-details.php?nid=<?php echo htmlentities($row['pid'])?>"> <img class="card-img-top" src="admin/postimages/<?php echo htmlentities($row['PostImage']);?>" alt="<?php echo htmlentities($row['posttitle']);?>"></a>
            ...
            <div class="card-footer text-muted">
              Postedo em: <?php echo htmlentities($row['postingdate']);?>
...
<?php } ?>
    ...
    <ul class="pagination justify-content-center mb-4">
        ...
        <li class="<?php if($pageno <= 1){ echo 'disabled'; } ?> page-item">
            <a href="<?php if($pageno <= 1){ echo '#'; } else { echo "?pageno=".($pageno - 1); } ?>" class="page-link">Previsualizar</a>
        </li>
