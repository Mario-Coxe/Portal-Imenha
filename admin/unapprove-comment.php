...
<html lang="en">
    <head>
        ...
        <title>Portal IMENHAe | Comentários</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Comentários esperando serem Aprovados</h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="#">Afonso Silva</a>
                                        </li>
                                        <li>
                                            <a href="#">Comentários </a>
                                        </li>
                                        <li class="active">
                                        Comentários esperando serem Aprovados
                                        </li>
                                    </ol>
...
<td>
<?php if($st=='0'):?>
    <a href="unapprove-comment.php?disid=<?php echo htmlentities($row['id']);?>" title="Desaprovar este comentário"><i class="ion-arrow-return-right" style="color: #29b6f6;"></i></a> 
<?php else :?>
  <a href="unapprove-comment.php?appid=<?php echo htmlentities($row['id']);?>" title="Aprovar este comentário"><i class="ion-arrow-return-right" style="color: #29b6f6;"></i></a> 
<?php endif;?>
