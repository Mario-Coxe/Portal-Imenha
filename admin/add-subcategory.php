...
<html lang="en">
    <head>
        ...
        <title>Portal IMENHA | Adicionar Sub-Categoria</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Adicionar Sub-Categoria</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Adicionar Sub-Categoria </b></h4>
                                    <hr />
...
<?php } ?>
    ...
    <div class="form-group">
	                                            ...
	                                            <div class="form-group">
	                                                <label class="col-md-2 control-label">Sub-Categoria Descrição</label>
	                                                <div class="col-md-10">
