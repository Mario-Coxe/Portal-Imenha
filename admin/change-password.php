...
$msg="Palavra Passe trocada com sucesso!!";
}
}
else
{
$error="Erro ao trocar a palavra passe!!";
}
}
...
<html lang="en">
    <head>
        ...
        <title>Portal IEMNHA| Adicionar Categoria</title>
...
{
alert("A Palavra Passe está vazia!!");
document.chngpwd.password.focus();
return false;
}
else if(document.chngpwd.newpassword.value=="")
{
alert("Nova Palavra Passe está vazia !!");
document.chngpwd.newpassword.focus();
return false;
}
else if(document.chngpwd.confirmpassword.value=="")
{
alert("Confirmar a Palavra Passe está vazia !!");
document.chngpwd.confirmpassword.focus();
return false;
}
else if(document.chngpwd.newpassword.value!= document.chngpwd.confirmpassword.value)
{
alert("Erro na Palavra Passe e confirmar palavra passe !!");
document.chngpwd.confirmpassword.focus();
return false;
}
return true;
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Trocar Palavra-Passe</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Trocar Palavra-Passe</b></h4>
                                    <hr />
...
<strong>Erro!</strong> <?php echo htmlentities($error);?></div>
<?php } ?>
...
<div class="form-group">
<label class="col-md-4 control-label">Palavra-Passe Nova</label>
<div class="col-md-8">
