...
<html lang="en">
    <head>
        ...
        <title>Portal IMENHA| Configurar Comentários</title>
...
<td>
<?php if($st==0):?>
    <a href="manage-comments.php?disid=<?php echo htmlentities($row['id']);?>" title="Desaprovar este comentário"><i class="ion-arrow-return-right" style="color: #29b6f6;"></i></a> 
<?php else :?>
  <a href="manage-comments.php?appid=<?php echo htmlentities($row['id']);?>" title="Aprovar este comentário"><i class="ion-arrow-return-right" style="color: #29b6f6;"></i></a> 
<?php endif;?>
