...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Portla IMENHA | Manage Posts</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Configuração dos Posts </h4>
...
<td colspan="4" align="center"><h3 style="color:red">Vazio</h3></td>
<tr>
<?php 
} else {
