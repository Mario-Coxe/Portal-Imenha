...
if($_GET['resid'])
{
	...
	$msg="Categoria restaurada com sucesso";
}
...
if($_GET['action']=='perdel' && $_GET['scid'])
{
	...
	$delmsg="Categoria eliminada para sempre";
}
...
<html lang="en">
    <head>
        ...
        <title> Portal IMENHA | Configuração das SubCategorias</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Configuração das SubCategories</h4>
...
<td colspan="7" align="center"><h3 style="color:red">Vazio</h3></td>
<tr>
<?php 
} else {
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i> Apagar sub-categorias</h4>
...
<td><?php echo htmlentities($row['subcatpostingdate']);?></td>
<td><?php echo htmlentities($row['subcatupdationdate']);?></td>
<td><a href="manage-subcategories.php?resid=<?php echo htmlentities($row['subcatid']);?>"><i class="ion-arrow-return-right" title="Restaurar está SubCategory"></i></a>
