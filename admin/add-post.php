...
{
echo "<script>alert('Inválido formato. Apenas jpg / jpeg/ png /gif format allowed');</script>";
}
else
{
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Portal IEMNHA | Add Post</title>
...
<button type="submit" name="submit" class="btn btn-success waves-effect waves-light">Salvar e Postar</button>
 <button type="button" class="btn btn-danger waves-effect waves-light">Discartar</button>
                                        </form>
                                    </div>
                                </div> <!-- end p-20 -->
                            </div> <!-- end col -->
