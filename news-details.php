...
if($query):
  echo "<script>alert('Comentário adicionado com sucesso, espere o Administrador adicionar na página! ');</script>";
...
<html lang="en">
  ...
  <head>
    ...
    <title>Portal IMENHA | Lendo</title>
      ...
      <div class="row" style="margin-top: 4%">
        <div class="col-md-3">
         <?php include"includes/leftsidebar.php";  ?>
          ...
          <!-- Side Widget -->
          <div class="card my-4">
            <h5 class="card-header bg-primary text-light">Recente Postagens</h5>
            <div class="card-body">
                      <ul class="mb-0">
<?php
          ...
          <div class=" mb-4">
            ...
            <div class="card-body">
              ...
              <p><b>Categoria : </b> <a href="category.php?catid=<?php echo htmlentities($row['cid'])?>"><?php echo htmlentities($row['category']);?></a> |
                <b>Sub Categoria : </b><?php echo htmlentities($row['subcategory']);?> <b> Postado em: </b><?php echo htmlentities($row['postingdate']);?></p>
                <hr />
...
<!---Comment Section --->
 ...
 <div class="row m-5">
   <div class="col-md-12">
<div class="card my-4">
            <h5 class="card-header bg-primary text-light">Comentário:</h5>
            <div class="card-body">
